...
double t_cdf(double x, double f) {
    students_t_distribution<double> d(f);
    return cdf(d, x);
}
...
double chi_cdf(double x, double f) {
    chi_squared_distribution<double> d(f);
    return cdf(d, x);
}
...
double f_cdf(double x, double f1, double f2) {
    fisher_f_distribution<double> d(f1, f2);
    return cdf(d, x);
}
...
double nct_cdf(double x, double f, double delta) {
    non_central_t_distribution<double> d(f, delta);
    return cdf(d, x);
}
...
double nchi_cdf(double x, double f, double delta) {
    non_central_chi_squared_distribution<double> d(f, delta);
    return cdf(d, x);
}
...
double ncf_cdf(double x, double f1, double f2, double delta) {
    non_central_f_distribution<double> d(f1, f2, delta);
    return cdf(d, x);
}
...
double binom_cdf(double k, double n, double p) {
    binomial_distribution<double> d(n, p);
    return cdf(d, k);
}
